...
from PySide2.QtWidgets import (QApplication,QMainWindow,QLabel,QFrame,QSizePolicy,QPushButton,
                               QSpacerItem,QTabWidget,QWidget,QGridLayout,QStyle,QPlainTextEdit,QHBoxLayout,
